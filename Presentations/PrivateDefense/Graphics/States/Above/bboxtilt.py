...
#																			
#############################################################################
def drawBoundingBox(box, tilt, dirid, padding=0.0, linewidth=2.0, r=1.0, g=1.0, b=1.0):	 
		"""																  
		DESCRIPTION														  
		...
		([minX, minY, minZ],[maxX, maxY, maxZ]) = ([-box, -box, -box],[box, box, box])
		...
		if padding != 0:
 		...
 		if dirid == 0:
			boundingBox = [
					...
					VERTEX, minX + tilt, maxY, minZ,	   #3
					VERTEX, minX + tilt, maxY, maxZ,	   #4
	 
					VERTEX, maxX, minY, minZ,	   #5
					VERTEX, maxX, minY, maxZ,	   #6
	 
					VERTEX, maxX + tilt, maxY, minZ,	   #7
					VERTEX, maxX + tilt, maxY, maxZ,	   #8
			...
			boundingBox = [
					...
					VERTEX, minX, minY, minZ,	   #1
					VERTEX, minX, minY + tilt, maxZ,	   #2
	 
					VERTEX, minX, maxY, minZ,	   #3
					VERTEX, minX, maxY + tilt, maxZ,	   #4
	 
					VERTEX, maxX, minY, minZ,	   #5
					VERTEX, maxX, minY + tilt, maxZ,	   #6
	 
					VERTEX, maxX, maxY, minZ,	   #7
					VERTEX, maxX, maxY + tilt, maxZ,	   #8
			...
			boundingBox = [
					...
					VERTEX, minX, minY, minZ,	   #1
					VERTEX, minX + tilt, minY, maxZ,	   #2
	 
					VERTEX, minX, maxY, minZ,	   #3
					VERTEX, minX + tilt, maxY, maxZ,	   #4
	 
					VERTEX, maxX, minY, minZ,	   #5
					VERTEX, maxX + tilt, minY, maxZ,	   #6
