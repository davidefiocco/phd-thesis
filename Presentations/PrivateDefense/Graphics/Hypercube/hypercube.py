...
for i in range(1):
	...
	#nx.draw_networkx_nodes(G, pos = pos, cmap = get_cmap('jet'), node_size=200, node_color = 'k')
	nx.draw_networkx_edges(G, pos = pos)
	fig = matplotlib.pyplot.gcf()
	fig.set_size_inches(8,8)
	savefig('hypercube.png', bbox_inches = 'tight')
	#savefig('hypercube-' + str(i) + '.png', bbox_inches = 'tight')
	close()
